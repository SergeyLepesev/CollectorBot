...
{
    public class DisapproveCommand : ITelegramCommand
    {
        ...
        public async Task ExecuteAsync(Message message)
        {
            ...
            transaction.Status = Status.Disapproved;
            ...
            await _bot.SendTextMessageAsync(refer.TelegramUserId, "Transaction disapproved");
